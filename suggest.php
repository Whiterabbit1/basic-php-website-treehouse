...
if($_SERVER["REQUEST_METHOD"] == "POST") {
	...
	if (!isset($error_message)) {
		...
		$mail->addAddress('me@myemail.com', 'My Name');     // Add a recipient
...
<div class="section page">
	<div class="wrapper">
		...
		<?php if (isset($_GET["status"]) && $_GET["status"] == "thanks") {
			echo "<p>Thank You for your email! I&rsquo;ll check out your suggestion shortly!</p>";
		} else {?>
